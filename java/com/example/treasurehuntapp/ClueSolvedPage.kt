...
@Composable
fun ClueSolvedPage(onContinueClicked: () -> Unit, clueInfo: String,totalElapsedTime: Long) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Text("Congratulations! You've solved the clue.")
        Spacer(modifier = Modifier.height(16.dp))
        Text("Info about the location: $clueInfo")
        Spacer(modifier = Modifier.height(16.dp))
